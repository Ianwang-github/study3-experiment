...
const SHARED_SECRET = "study3v4_ntust_2026_x7k2";
...
const HEADERS = [
  ...
  // 信任、情緒、負荷
  "trust_1", "trust_2", "trust_3", "trust_4", "sam_pleasure", "sam_arousal", "tlx_1", "tlx_2",
...
function doPost(e) {
  ...
  trials.forEach(function (t) {
    ...
    const row = [
      ...
      a.trust_1, a.trust_2, a.trust_3, a.trust_4, a.sam_pleasure, a.sam_arousal, a.tlx_1, a.tlx_2,
  ...
  const fake = {
    ...
    trials: [{
      ...
      answers: { judge_1: 1, judge_2: 0, judge_3: 0, judge_4: 1,
                 ...
                 trust_1: 4, trust_2: 3, trust_3: 4, trust_4: 3, sam_pleasure: 4, sam_arousal: 5, tlx_1: 5, tlx_2: 4,
                 },
